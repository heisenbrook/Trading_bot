...
import os
from utils.keys import train_data_folder, data_folder, fine_tuning_data_folder
...
def plot_closes_fine_tuning(targets, preds):
    """
    Plots real vs predicted closes and saves the figure.
...
def plot_loss_fine_tuning(train_losses, test_losses):
    """
    Plots training and test loss over epochs and saves the figure.
    Modified for fine-tuning context.
    """
